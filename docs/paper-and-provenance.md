...
The implementation release is derived from the selected source revision
`1373f5507c1680c60a7700d8a6c26a8b4d3fb025`. The checked-in
...
this release. Historical research artifacts remain separate from this
implementation release. Do not infer that an implementation path or release
descriptor broadens the paper's stated experimental or deployment boundary.
